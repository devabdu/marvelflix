class ApiConst {
  ...
  static const String baseCoverUrl =
      'https://res.cloudinary.com/augustomarcelo/image/upload/v1675206317/mcuapi/gallery';
  static const String baseTrailerUrl =
      'https://players.brightcove.net/5359769168001/BJemW31x6g_default/index.html';

  static traileUrl(int trailerId) => '$baseTrailerUrl?videoId=$trailerId';
