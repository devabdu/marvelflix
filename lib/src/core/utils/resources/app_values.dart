...
class ConstEdgeInsetsGeometry {
  static const EdgeInsetsGeometry defaultPaddingAuth = EdgeInsets.only(
      top: AppPadding.p50, right: AppPadding.p30, left: AppPadding.p30);

  static const EdgeInsetsGeometry defaultPaddingHomeScreens =
